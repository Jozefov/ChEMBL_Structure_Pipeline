...
#PBS -o /storage/plzen1/home/jozefov_147/projects/msngym/data/candidates_generation/pubchem_canon_molecules/canon_1M.stdout
#PBS -e /storage/plzen1/home/jozefov_147/projects/msngym/data/candidates_generation/pubchem_canon_molecules/canon_1M.stderr
...
python "$REPO_DIR/scripts/canonicalize_pubchem.py" \
    ...
    --checkpoint-name "MassSpecGym_retrieval_molecules_1M_canonicalized.tsv" \
    $RESUME_FLAG \
    > "$SCRATCHDIR/canon_1M.log" 2>&1
...
tail -20 "$SCRATCHDIR/canon_1M.log" 2>/dev/null || true
clean_scratch
exit $EXIT_CODE
